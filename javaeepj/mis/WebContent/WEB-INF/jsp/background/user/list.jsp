...
function permissio(userName){
	 var url = "${pageContext.servletContext.contextPath }/background/resources/permissioUser.do?userName="+userName;
	 var h_sp1 = 400;
	 var w_sp1 = 350;
...
function userRole(userName){
	 var url = "${pageContext.servletContext.contextPath }/background/user/userRole.do?userName="+userName;
	 var h_sp1 = 420;
	 var w_sp1 = 600;
	//兼容IE，firefox,google.模态窗口居中问题
	 var iTop2 = (window.screen.availHeight - 20 - h_sp1) / 2;
              ...
              <tr>
                ...
                <td width="60"><table width="90%">
                  <tr>
                    ...
                    <td class="STYLE1"><div align="center"><a href="${pageContext.servletContext.contextPath }/background/user/addUI.do">新增</a></div></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <td><table class="ttab" width="100%" cellspacing="1" onmouseover="changeto()"  onmouseout="changeback()">
          ...
          <tr>
            ...
            <td height="20" ><span class="STYLE1"><a href="${pageContext.servletContext.contextPath }/background/user/getById.do?userId=${key.userId}&userName=${key.userName}&type=0">${key.userName}</a></span></td>
            ...
            <c:if test="${!empty resMap.sys_user_fenpeirole}">
            ...
            <c:if test="${!empty resMap.sys_user_edit}">
            <img src="${pageContext.servletContext.contextPath }/images/edt.gif" width="16" height="16" />
            <a href="${pageContext.servletContext.contextPath }/background/user/getById.do?userId=${key.userId}&userName=${key.userName}&type=1">
                                     编辑
            </a>
            &nbsp; &nbsp;
           </c:if>
           <c:if test="${!empty resMap.sys_user_delete}">
            <img src="${pageContext.servletContext.contextPath }/images/del.gif" width="16" height="16" />
            	<a href="javascript:void(0);" onclick="deleteId('${pageContext.servletContext.contextPath }/background/user/deleteByUserId.do?userId=${key.userId}');">
            	删除</a>
            </c:if>
            	</span></td>
          </tr>
